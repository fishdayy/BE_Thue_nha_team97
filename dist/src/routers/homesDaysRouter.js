...
exports.homesDaysRouter.delete("/:id", homesDaysController_1.default.deleteHomesDays);
exports.homesDaysRouter.delete("/remove/:id", homesDaysController_1.default.deleteHomesDays2);
